...
namespace Viagogo
{
    ...
    public class Solution
    {
        static void Main(string[] args)
        {
            ...
            //If GetDistance() is expensive or could fai or time out, we provide a try catch to handle failure and a retry to fetch data again whenever there is failure. 
